const poly = {
  ...
  wkb: {type: 'wkb', data: `AQMAAAABAAAABwAAAAAAAAARcFXAJgQ8deciQ0D///+PFnFVwPdxsjQpIENA////75puVcAzTdHhbyBDQAAAAIALblXAaN2/Io8iQ0AAAABwhG5VwAs8Y00uJUNAAAAAMC1vVcBxxJY7nCFDQAAAAAARcFXAJgQ8deciQ0A=`},
  circle: {type: 'circle',
    data: {
      center:
  ...
  rectangles: {type: 'rectangles', 
    data: {
      bounds:{south:38.25728983213629,west:-85.76575756072998,north:38.257812161128484,east:-85.7618522644043},
      path:[{lat:38.257812161128484,lng:-85.76575756072998},{lat:38.257812161128484,lng:-85.7618522644043},{lat:38.25728983213629,lng:-85.76575756072998},{lat:38.25728983213629,lng:-85.7618522644043}],
